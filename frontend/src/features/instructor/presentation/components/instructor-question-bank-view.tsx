...
const InstructorQuestionBankView = () => {
  ...
  const [formDifficulty, setFormDifficulty] = useState<DifficultyLevel>(
  ...
  useEffect(() => {
    if (editingQuestion) {
      ...
      setFormDifficulty(
        editingQuestion.props?.difficulty || DifficultyLevel.MEDIUM,
      );
  ...
  useEffect(() => {
    if (formType === QuestionType.TRUE_FALSE) {
      ...
      formOptions[0].content === "True" &&
      formOptions[1].content === "False"
    ) {
  ...
  useEffect(() => {
    ...
    if (
      (formType === QuestionType.SINGLE_CHOICE ||
                  ...
                  {filteredQuestions.map((q: any) => (
                    ...
                    >
                      <TableCell className="font-medium">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <span className="line-clamp-2 leading-relaxed text-sm text-slate-500 font-normal">
                              {q?.props?.content}
                            </span>
                          </div>
                        </div>
                          ...
                          {q?.props?.tags && q?.props?.tags.length > 0 ? (
                            q?.props?.tags.map((tag: string, idx: number) => (
                              <Badge
                                key={idx}
                                variant="outline"
                                className="text-[11px] bg-slate-50"
                              >
                                {tag}
                              </Badge>
                            ))
                      ...
                      <TableCell>
                        <Badge
                          variant={
                            q?.props?.difficulty === DifficultyLevel.EASY
                              ? "success"
                              : q?.props?.difficulty === DifficultyLevel.MEDIUM
                                ? "warning"
                                : "destructive"
                          }
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              ...
                              onClick={() =>
                                setDeleteConfirmId(q._id?.value || q.id)
                              }
                            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormDifficulty(val as DifficultyLevel)
                  }
                >
                  <SelectTrigger
                    id="form-difficulty"
            ...
            <div className="space-y-4 border-t pt-4">
              <div className="flex items-center justify-between">
                ...
                {formType !== QuestionType.TRUE_FALSE && (
                  <Button
                    ...
                    className="h-8 text-xs border-dashed border-emerald-600 text-emerald-600 hover:bg-emerald-50"
                  >
              ...
              <div className="space-y-3">
                {formOptions.map((option, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col gap-2 p-3 border rounded-lg bg-slate-50/50"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex items-center space-x-2 mt-2 shrink-0">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            handleOptionChange(idx, "isCorrect", !!checked)
                          }
                          className="border-slate-400 data-[state=checked]:bg-emerald-500 data-[state=checked]:border-emerald-500"
                        />
                        <Label
                          htmlFor={`correct-${idx}`}
                          className="text-xs font-semibold cursor-pointer text-slate-600 whitespace-nowrap"
                        >
                    ...
                    <div className="pl-6">
                      <Input
                        ...
                        onChange={(e) =>
                          handleOptionChange(idx, "explanation", e.target.value)
                        }
            ...
            <div className="space-y-6 py-4">
              <div>
                <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">
                  {previewingQuestion?.props?.title}
                </h3>
                <p className="mt-2 text-sm text-slate-600 leading-relaxed bg-slate-50 p-4 rounded-lg border border-slate-100">
                  {previewingQuestion?.props?.content}
                </p>
              </div>
              ...
              <div className="flex gap-4">
                <div>
                  ...
                  <Badge className="mt-1 font-semibold uppercase">
                    {previewingQuestion?.props?.difficulty}
                  </Badge>
                </div>
                <div>
                  <span className="text-xs text-muted-foreground block">
                  ...
                  <Badge
                    variant="outline"
                    className="mt-1 font-semibold uppercase border-slate-300"
                  >
                    {previewingQuestion?.props?.type}
                  </Badge>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                {previewingQuestion?.props?.options?.map(
