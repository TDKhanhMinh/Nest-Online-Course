...
export class InstructorProfile extends Entity<InstructorProfileProps> {
  ...
  get headline(): string { return this.props.headline; }
  ...
  get twitter(): string | undefined { return this.props.twitter; }
  get linkedin(): string | undefined { return this.props.linkedin; }
  get youtube(): string | undefined { return this.props.youtube; }

  public static create(props: Omit<InstructorProfileProps, 'totalStudents'>, id?: string): InstructorProfile {
    return new InstructorProfile({ ...props, totalStudents: 0 }, id ? new UniqueId(id) : UniqueId.generate());
  }

  public static reconstitute(props: InstructorProfileProps, id: UniqueId): InstructorProfile {
