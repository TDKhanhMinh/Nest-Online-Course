...
import { ICartItemRepository } from '@domain/cart/ports/i-cart-item.repository';
import { CartItemMapper } from '../mappers/cart-item.mapper';

@Injectable()
export class MongooseCartItemRepository implements ICartItemRepository {
  constructor(
